...
const Index = () => {
  ...
  useEffect(() => {
    if (selectedAuditRef) {
      ...
      // Check if we have findings already saved for this audit
      const findings = getFindingsByAuditRef(selectedAuditRef);
      if (findings.length > 0) {
        const findingsMap: Record<string, any> = {};
        findings.forEach(finding => {
          findingsMap[finding.checklistItemId] = {
